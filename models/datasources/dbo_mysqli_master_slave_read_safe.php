...
class DboMysqliMasterSlaveReadSafe extends DboMysqli {
	
	public $description = "MySQLi DBO Driver with support for Master/Slave database setup";
	...
	/**
	 * Override _execute to make use of master or slave connection
	 *
	 * @param string $sql 
	 * @return resource
	 */
